            ...
            <div className="w-full max-w-md">
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h1 className="text-2xl font-bold text-gray-900 mb-2">声吧活动配置管理</h1>
                ...
                <div className="text-center mt-8">
                    <p className="text-sm text-gray-500">© 2024 声吧活动配置管理系统</p>
                    <p className="text-xs text-gray-400 mt-1">安全登录 · 数据保护</p>
                </div>
            </div>
