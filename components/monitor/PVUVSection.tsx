...
import { PVUVData, DailyPVUVData, TableRowData, ChartDataPoint } from '../../types/monitor-dashboard';
                    ...
                    <div className="space-y-1">
                        {entries.map(([key, value]: [string, any]) => (
                            <div key={key} className="text-xs text-gray-600">
                                ...
                                <span className="ml-1 text-blue-600">{value.pv.toLocaleString()}</span>
                                <span className="mx-1 text-gray-400">/</span>
                                <span className="text-green-600">{value.uv.toLocaleString()}</span>
                            </div>
                        ))}
                    </div>
                );
