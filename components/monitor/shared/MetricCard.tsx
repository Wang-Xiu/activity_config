        ...
        `}>
            <div className="flex items-start justify-between">
                <div className="flex-1">
                    <p className={`${sizeClass.title} font-medium ${colorClass.text} opacity-80 mb-2`}>
                        {title}
                    </p>
                    <div className="flex items-baseline space-x-2">
                        <p className={`${sizeClass.value} font-bold ${colorClass.text} leading-none`}>
                            {formatValue(value)}
                        </p>
                        {unit && (
